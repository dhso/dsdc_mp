...
@Coller(value = { "/wechat/oauth2" }, path = "wechat")
public class WxRedirectUriCtrl extends ApiController{
	/**
	...
	public void oauth() {
		String appId = getApiConfig().getAppId();
		String redirectUri = WeixinKit.urlEncodeUTF8(PropKit.get("domain") + "/oauth2");
