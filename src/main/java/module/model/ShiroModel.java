...
public class ShiroModel extends Model<ShiroModel> {
	 ...
	 * @return
	 */
	public ShiroModel findUser(String username) {
	 ...
	 * @return
	 */
	public Record findRole(String username) {
		ShiroModel user = findUser(username);
		Record role = null;
		if (null != user) {
	 ...
	 * @return
	 */
	public List<Record> findAllPermission() {
	 ...
	 * @return
	 */
	public Page<Record> findAllPermissionPage(Integer pageNumber, Integer pageSize) {
	 ...
	 * @return
	 */
	public List<Record> findUrls(String username) {
		Record role = findRole(username);
	 ...
	 * @return
	 */
	public Page<Record> findAllUrlsPage(Integer pageNumber, Integer pageSize) {
	 ...
	 * @return
	 */
	public List<Record> findAllUrls() {
	 ...
	 * @return
	 */
	public Page<Record> findAllUrlsTypePage(Integer pageNumber, Integer pageSize) {
	 ...
	 * @return
	 */
	public List<Record> findAllUrlsType() {
	 ...
	 * @return
	 */
	public List<Record> findAllUser() {
	 ...
	 * @return
	 */
	public Page<Record> findAllUserPage(Integer pageNumber, Integer pageSize) {
